...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "worktajmMs@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "worktajmMs API";

        private String description = "worktajmMs API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "worktajmMs";
